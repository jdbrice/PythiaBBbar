...
void setupPythia( int trigger, long int seed = 0 ){
	...
	hFullAcc_dNdM_pT = new TH2D( "hFullAcc_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
	hPairCut_dNdM_pT = new TH2D( "hPairCut_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
	hAccCut0_dNdM_pT = new TH2D( "hAccCut0_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
	hAccCut1_dNdM_pT = new TH2D( "hAccCut1_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
	...
	heFullAcc_dNdM_pT = new TH2D( "heFullAcc_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
	hePairCut_dNdM_pT = new TH2D( "hePairCut_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
	heAccCut0_dNdM_pT = new TH2D( "heAccCut0_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
	heAccCut1_dNdM_pT = new TH2D( "heAccCut1_dNdM_pT", ";M (GeV/c^2); p_{T} (GeV/c)", 1000, 0, 5, 2000, 0, 10 );
